...
echo_and_run cd "/home/karthik/ur5_ws/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/karthik/ur5_ws/src/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/karthik/ur5_ws/build/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
