...
def publisher():
    ...
    while not rospy.is_shutdown():
        ...
        rospy.sleep(1)
        # user_input = input("Enter 'x' to exit: ")
        # if user_input == "x":
        break
        # break
...
class UR5:
    ...
    def __init__(self,
        ...
        # self.gripper_pub.publish(gen_command('r', self.command))
        # self.gripper_pub.publish(gen_command('a', self.command))
        rospy.sleep(1)
    ...
    def open_gripper(self):
        self.gripper_pub.publish(gen_command("o", self.command))
        rospy.sleep(3)

    def close_gripper(self):
        self.gripper_pub.publish(gen_command("c", self.command))
        rospy.sleep(3)
